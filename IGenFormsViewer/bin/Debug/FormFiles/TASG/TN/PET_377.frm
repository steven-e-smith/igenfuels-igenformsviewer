...
<Forms> 
    <Group></Group> 
    <Datasource>server=IGLT-0039\SQLEXPRESS;database=IGenFuels_Data_US_QA;trusted_connection=true;</Datasource> 
    <DataSetName></DataSetName> 
    <Datasets>
        <Dataset>
            <Name>Div</Name> 
            <SQL>SELECT * From vw_WSTF WHERE (Filing_Jurisdiction) = 'TN' AND (Return_Code) = 'PET 377' AND ' (Schedule_Code) = '11E'</SQL> 
        </Dataset>
    </Datasets>
    <Form>
        <Name>PET377</Name> 
        ...
        <Fields>
            ...
            <Field>
                ...
                <Text></Text> 
                <Caption></Caption> 
                <Value>=if((([1.0.11.B] - [1.0.11.A] - [1.0.12.B] + [1.0.13.B] + [1.0.14.B]) * -1) > 0, (([1.0.11.B] - [1.0.11.A] - [1.0.12.B] + [1.0.13.B] + [1.0.14.B]) * -1), 0)</Value> 
                <FormatMask></FormatMask> 
                <Instructions></Instructions> 
                <List></List> 
                <Tag> </Tag> 
    ...
    <Form>
        ...
        <RowsPerPage>30</RowsPerPage> 
        <ProcessingOrder>8</ProcessingOrder> 
        <PrintOrientation>P</PrintOrientation> 
        <DataSetName>Div</DataSetName> 
        <Instructions></Instructions> 
        <Fields>
            <Field>
